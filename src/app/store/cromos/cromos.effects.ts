...
export class CromosEffects {
  ...
  //     exhaustMap((action: any) => this.service.getCollectionById(action.collection_id)
  //       .pipe(
  //         map((collection) => {
  ...
  //   return this.actions$.pipe(
  //     ofType(getCromos),
  //     exhaustMap((action: any) => this.service.getCromoTypeByCollectionId(action.collection_id)
  //       .pipe(
  //         map((cromos) => {
